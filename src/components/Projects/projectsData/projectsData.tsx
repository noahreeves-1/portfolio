...
export const projectsData: IProject[] = [
  {
    ...
    techStack: "React, TypeScript, Tailwind, Node.js, Express, MongoDB",
    description:
      "A full-stack web app where I can write and publish blog posts. The app is protected with user authentication and JWT Tokens.",
    warning:
  ...
  },
  {
    ...
    description:
      "A full-stack web app that allows only users to post like a forum. However, only members who know the secret code are allowed to see who the author of each post is.",
    warning:
      "Site unavailable - MongoDB pauses free clusters with prolonged inactivity.",
  ...
  },
  {
    ...
    description:
      "A full-stack shop-like web app with items and a shopping cart allowing users to add and remove items from their cart. Payments not enabled because it is not a real shop.",
    warning:
      "Site unavailable - MongoDB pauses free clusters with prolonged inactivity.",
